...
class MockProver:
    """Return deterministic Lean proofs; verification uses real lean-interact."""
...
def main():
    ...
    with tempfile.TemporaryDirectory() as tmpdir:
        packed = _run_vllm_batch_mode(
            ...
            verify_fn=None,  # Use real LeanChecker + lean-interact in parallel workers.
        )
    ...
    print("[PASS] lean-interact parallel verification (k=4)")
